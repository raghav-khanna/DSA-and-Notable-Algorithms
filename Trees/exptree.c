//Making Expression tree from Postfix
...
void exptree(char postfix[100],struct treenode** root){
    struct node* top = NULL;
...
void main()
{
    ...
    printf("Expression Tree was made successfully. Inorder Traversal is - ");
    inOrder(root);
